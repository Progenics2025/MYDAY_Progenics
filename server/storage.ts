...
export interface IStorage {
  ...
  // Profile operations
  updateEmployeeProfile(profile: { employeeId: string; phoneNumber?: string; emergencyContact?: string; address?: string; dateOfBirth?: string; bloodGroup?: string; maritalStatus?: string; photo?: string; skills: string[]; education: string[]; experience: string[] }): Promise<any>;
